...
const _kDefaultDelay = Duration(milliseconds: 250);
const _kDoubleTapMaxOffset = 48.0;
...
class PositionedTapDetector extends StatefulWidget {
  const PositionedTapDetector({
    ...
    this.onDoubleTap,
    this.onLongPress,
    this.doubleTapDelay = _kDefaultDelay,
    this.behavior,
    this.controller,
  }) : super(key: key);
...
class _TapPositionDetectorState extends State<PositionedTapDetector> {
  ...
  bool _isDoubleTap(TapDownDetails d1, TapDownDetails d2) {
    ...
    return sqrt(dx * dx + dy * dy) <= _kDoubleTapMaxOffset;
  }
